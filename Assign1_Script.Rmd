...
##### Important information needed about the primers and adaptors 
...
Start by downloading BBMap package following the installation instructions from https://jgi.doe.gov/data-and-tools/bbtools/bb-tools-user-guide/installation-guide/
...
```{r, eval=FALSE}
path <- "~/Downloads/HW_1/its2_sids_rads/its2_sids_rads" 
```
