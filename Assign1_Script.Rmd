...
path <- "C:/Users/corey/Downloads/HW_1/its2_sids_rads/its2_sids_rads" # CHANGE ME to the directory containing the fastq files after unzipping.
fns <- list.files(path)
fns

setwd( "C:/Users/corey/Downloads/HW_1/its2_sids_rads/its2_sids_rads")
getwd()
gunzip("H7_bh_sid_18_ITS2_R2.fastq.gz")
